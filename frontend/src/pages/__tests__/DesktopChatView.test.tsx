...
function createMockStore() {
  return createStore<MitzoStoreState>(() => ({
    ...
    tasks: { tree: [], loopStatus: { state: 'idle', goalId: null, activeTaskId: null, progress: null, specMode: false, awaitingApproval: false } },
    inbox: { items: [], count: 0 },
    ...
    tokens: { agentContext: 0, contextCeiling: 200_000, sessionTotal: 0, numTurns: 0, turnIndex: 0 },
    sendError: null,

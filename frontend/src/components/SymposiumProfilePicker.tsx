...
export function SymposiumProfilePicker({ value, onChange, disabled = false }: Props) {
  ...
  return (
    <section aria-label="Portable Symposium profile">
      ...
      {exportJson && <textarea aria-label="Portable profile export" readOnly value={exportJson} />}
      <label>
        Import profile JSON
        <textarea
          disabled={disabled || busy}

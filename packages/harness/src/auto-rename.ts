...
const STOP_WORDS = new Set([
  ...
  'with', 'by', 'from', 'is', 'it', 'be', 'as', 'do', 'if', 'so', 'we', 'my',
  'me', 'i', 'that', 'this', 'can', 'also', 'just', 'all', 'not', 'are', 'was',
  'has', 'have', 'had', 'been', 'will', 'would', 'could', 'should', 'may',
  'might', 'shall', 'need', 'want', 'please', 'some', 'any', 'no', 'yes', 'up',
  'out', 'about', 'into', 'over', 'then', 'than', 'them', 'they', 'their',
  'there', 'here', 'when', 'what', 'which', 'how', 'who', 'where', 'why',
  'each', 'every', 'very', 'too', 'more', 'most', 'other', 'our', 'your',
  'its', 'you', 'he', 'she', 'his', 'her',
]);
